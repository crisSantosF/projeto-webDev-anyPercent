...
palavra_rotatoria.addEventListener('animationend', (tipo_rotacao) =>
{

    if (tipo_rotacao.animationName === 'rotacao_desaparece') {
        trocar_palavra_e_aparecer();
    } else if (tipo_rotacao.animationName === 'rotacao_aparece') {
        agendar_proxRotacao();
    }
});
